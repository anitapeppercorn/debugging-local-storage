...
var restaurantDisplay = document.querySelector("button#restaurant-display");
var displayMoreRestaurants = document.querySelector("button#display-more-restaurants");
...
var getRestaurants = function(){
  ...
  .then(function(response) {
    ...
    if (!noCuisineMatch) {
      ...
      var buttonList = document.querySelector("button#button-list");
